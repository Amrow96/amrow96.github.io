        ...
        <div class="row">
            <div class="col col-12 text-center ">
                        ...
                        <div class="col  col-12">
                            <div class="card-deck mb-3">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-header titulo">
                                            {{ textosMostrar[6].text }}
                                        </h5>
                                        <p class="card-text">
                                            {{ textosMostrar[7].text }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row col-12">
                    <button class="btn col-4" @click="modificarIdioma(0)">
                        Traduir al Català
                    </button>
                    <button class="btn col-4" @click="modificarIdioma(1)">
                        Traduir al Castella
                    </button>
                    <button class="btn col-4" @click="modificarIdioma(2)">
                        Traduir al Anglés
                    </button>
                </div>
            </div>
